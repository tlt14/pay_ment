...
namespace Pay1193.Controllers
{
    public class PaymentController : Controller
    {
        ...
        {
            var payRecords = _payService.GetAll().Select(pay => new PaymentIndexViewModel
            {
                Id = pay.Id,
        ...
        public IActionResult Detail(int id)
        {
            ...
            var model =
                new PaymentDetailViewModel()
                {
                    ...
                    Year =
                        _payService
                            .GetTaxYearById(paymentRecord.TaxYearId)
                            .YearOfTax,
                    ...
                    OvertimeRate =
                        _payService.OvertimeRate(paymentRecord.HourlyRate),
